					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="white-box">
							<div class="col-in row">
								<div class="col-xs-12">
									<h3 class="text-right m-t-15 ${data.id==1?"text-danger":data.id==2?"text-muted":"text-primary" }">${data.percent} %</h3>
								</div>
								<div class="col-xs-12">
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="progress">
										<div class="progress-bar ${data.id==1?"
											progress-bar-danger":data.id==2?
											"progress-bar-megna":"progress-bar-primary"}"
													role="progressbar"
